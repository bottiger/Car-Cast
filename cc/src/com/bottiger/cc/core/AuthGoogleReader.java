 ...
 */
public class AuthGoogleReader {
  private static final String TAG = AuthGoogleReader.class.getName();

  public static final String PREF_NAME = "Sample App";
  public static final String PREF_TOKEN = "accessToken";
  public static final String SCOPE = "oauth2:http://www.google.com/reader/api"; // Or "Google Buzz"
  ...
  public void refreshAuthToken(final Activity activity, final Account account) {
    ...
    AccountManager.get(activity).getAuthToken(account, SCOPE, true, cb, null);
  }
}